...
const styles = StyleSheet.create({
  ...
  appName: { fontFamily: 'Cairo_700Bold', fontSize: 22, color: Colors.textPrimary },
  ...
  title: { fontFamily: 'Cairo_800ExtraBold', fontSize: 24, color: Colors.textPrimary, textAlign: 'right', marginBottom: 4 },
