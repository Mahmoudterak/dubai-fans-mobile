...
const styles = StyleSheet.create({
  ...
  completionCard: { marginHorizontal: 16, backgroundColor: '#FFF7F7', borderRadius: 16, padding: 14, borderWidth: 1, borderColor: '#FFDCDC' },
  ...
  fieldRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 14 },
