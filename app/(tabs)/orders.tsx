...
const styles = StyleSheet.create({
  ...
  emptyDesc: { fontFamily: 'Cairo_400Regular', fontSize: 14, color: Colors.textMuted, marginTop: 8, textAlign: 'center' },
   emptyBtn: { marginTop: 24, backgroundColor: Colors.primary, borderRadius: 15, paddingHorizontal: 32, paddingVertical: 14, minHeight: 48, justifyContent: 'center' },
  emptyBtnText: { fontFamily: 'Cairo_700Bold', fontSize: 15, color: '#fff' },

  card: {
     backgroundColor: Colors.surface, borderRadius: 18, padding: 17,
