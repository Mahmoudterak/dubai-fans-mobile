...
const styles = StyleSheet.create({
  ...
  headerRow: { paddingHorizontal: 20, paddingTop: 14, paddingBottom: 4 },
  headerTitle: { fontFamily: 'Cairo_800ExtraBold', fontSize: 22, color: Colors.textPrimary, textAlign: 'right' },
  subtitle: { fontFamily: 'Cairo_400Regular', fontSize: 14, color: Colors.textMuted, textAlign: 'right', paddingHorizontal: 20, marginBottom: 16 },
  ...
  cardName: { fontFamily: 'Cairo_700Bold', fontSize: 15, color: Colors.textPrimary, textAlign: 'right', marginBottom: 6 },
  ...
  expertCard: {
    flexDirection: 'row', alignItems: 'center', gap: 10, marginHorizontal: 8, marginTop: 12,
    backgroundColor: '#FFF8F8', borderWidth: 1, borderColor: '#FAD4D5', borderRadius: 16, padding: 14,
  },
  expertIcon: { width: 42, height: 42, borderRadius: 14, backgroundColor: '#FFF0F0', alignItems: 'center', justifyContent: 'center' },
  expertCopy: { flex: 1, alignItems: 'flex-end' },
  expertTitle: { fontFamily: 'Cairo_700Bold', fontSize: 14, color: Colors.textPrimary, textAlign: 'right' },
  expertBody: { fontFamily: 'Cairo_400Regular', fontSize: 12, color: Colors.textMuted, textAlign: 'right', marginTop: 2 },
});
