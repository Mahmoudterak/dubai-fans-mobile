...
const styles = StyleSheet.create({
  ...
  balanceStrip: {
    ...
    backgroundColor: Colors.surface, borderRadius: 15, padding: 15, marginBottom: 18,
  ...
  sectionTitle: { fontFamily: 'Cairo_700Bold', fontSize: 18, color: Colors.textPrimary, textAlign: 'right', marginBottom: 15 },
  packageCard: { borderRadius: 20, padding: 19, marginBottom: 14, borderWidth: 1.5 },
  ...
  orderBtn: { borderRadius: 14, paddingVertical: 15, alignItems: 'center', minHeight: 50, justifyContent: 'center' },
